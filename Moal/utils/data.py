...
class iImageNet1000(iData):
    ...
    def download_data(self):
        ...
        train_dir = "/data1/zijian/data/imagenet/train/"
        test_dir = "/data1/zijian/data/imagenet/val/"
...
class iImageNet100(iData):
    ...
    def download_data(self):
        # assert 0, "You should specify the folder of your dataset"
        train_dir = "/data1/zijian/data/imagenet100/train/"
        test_dir = "/data1/zijian/data/imagenet100/test"
...
class CUB(iData):
    ...
    def download_data(self):
        # assert 0, "You should specify the folder of your dataset"
        train_dir = "/data1/zijian/data/cub/train"
        test_dir = "/data1/zijian/data/cub/test"
...
class objectnet(iData):
    ...
    def download_data(self):
        # assert 0, "You should specify the folder of your dataset"
        train_dir = "/data1/zijian/data/objectnet/train/"
        test_dir = "/data1/zijian/data/objectnet/test/"
...
class vtab(iData):
    ...
    def download_data(self):
        # assert 0, "You should specify the folder of your dataset"
        train_dir = "/data1/zijian/data/vtab/train/"
        test_dir = "/data1/zijian/data/vtab/test/"
